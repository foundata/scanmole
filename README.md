...
Exit codes: `0` success, `1` unexpected error, `2` usage error / no pages / all blank, `3` device or scan error, `4` missing dependency, `5` PDF assembly or OCR failed, `130` interrupted.
